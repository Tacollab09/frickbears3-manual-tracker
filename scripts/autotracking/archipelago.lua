...
function onClear(slot_data)
	...
	Tracker:FindObjectForCode("chardiff").CurrentStage = slot_data["difficulty"]
	Tracker:FindObjectForCode("cadetstories").CurrentStage = slot_data["stories"]
	Tracker:FindObjectForCode("death").CurrentStage = slot_data["jumpscaresanity"]
